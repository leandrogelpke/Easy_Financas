...
_Última atualização: 2026-08-22 16:32 BRT · base: 28 relatório(s) de auditoria na janela._

## Recomendações recorrentes

- 🔴 **(5x)** Verificar validade do token Bling (refresh/rotação) e disponibilidade da API v3.
  - _checks:_ `fetch_bling`
- 🔴 **(5x)** Conferir permissão contents:write e conflito de push.
  - _checks:_ `push_pages`
- 🔴 **(4x)** Falha recorrente em 'fetch' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
- 🔴 **(4x)** Falha recorrente em 'push' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
