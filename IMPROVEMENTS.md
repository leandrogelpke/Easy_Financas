...
_Última atualização: 2026-09-01 15:25 BRT · base: 21 relatório(s) de auditoria na janela._

## Recomendações recorrentes

- 🔴 **(14x)** Falha recorrente em 'fetch' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
- 🔴 **(14x)** Falha recorrente em 'push' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
- 🔴 **(2x)** Verificar validade do token Bling (refresh/rotação) e disponibilidade da API v3.
  - _checks:_ `fetch_bling`
- 🔴 **(2x)** Conferir permissão contents:write e conflito de push.
