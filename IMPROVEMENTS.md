...
_Última atualização: 2026-08-29 18:42 BRT · base: 21 relatório(s) de auditoria na janela._

## Recomendações recorrentes

- 🔴 **(21x)** Falha recorrente em 'fetch' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
- 🔴 **(21x)** Falha recorrente em 'push' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
