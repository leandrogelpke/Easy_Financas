...
_Última atualização: 2026-08-28 23:08 BRT · base: 22 relatório(s) de auditoria na janela._

## Recomendações recorrentes

- 🔴 **(22x)** Falha recorrente em 'fetch' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
- 🔴 **(22x)** Falha recorrente em 'push' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
