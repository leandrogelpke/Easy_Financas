...
_Última atualização: 2026-08-22 07:37 BRT · base: 29 relatório(s) de auditoria na janela._

## Recomendações recorrentes

- 🔴 **(3x)** Verificar validade do token Bling (refresh/rotação) e disponibilidade da API v3.
  - _checks:_ `fetch_bling`
- 🔴 **(3x)** Conferir permissão contents:write e conflito de push.
  - _checks:_ `push_pages`
- 🔴 **(2x)** Falha recorrente em 'fetch' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
- 🔴 **(2x)** Falha recorrente em 'push' — priorizar correção de causa-raiz.
  - _checks:_ `falha_recorrente`
